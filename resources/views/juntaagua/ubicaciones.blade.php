                    ...
                    success: function(data) {
                        if (data.msgError) {
                            ...
                            if(accion != 3){
                                ...
                                if (row.activo) {
                                     activo_icono = '<i data-lucide="Check" class="w-4 h-4 text-green-500" style="color: #10B981;"></i>'
                                     //activo_icono = 'SI';
                                }else{
                                    activo_icono = '<i data-lucide="X" class="w-4 h-4 text-red-500" style="color: #EF4444;"></i>';
                                    //activo_icono = 'NO';
                                }

                                if (row.casa_propia) {
                                    casa_propia_icono = '<i data-lucide="Check" class="w-4 h-4 text-green-250" style="color: #10B981;"></i>'
                                    //casa_propia_icono = 'SI';
                                }else{
                                    casa_propia_icono = '<i data-lucide="X" class="w-4 h-4 text-red-250" style="color: #EF4444;"></i>';
