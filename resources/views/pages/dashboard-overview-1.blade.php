            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex h-10 items-center">
                        <h2 class="mr-5 truncate text-lg font-medium">Reporte General</h2>
                        <a class="ml-auto flex items-center text-primary" href="">
                            <x-base.lucide class="mr-3 h-4 w-4" icon="RefreshCcw" /> Refrescar Datos
                        </a>
                    </div>
                    ...
                    <div class="mt-5 grid grid-cols-12 gap-6">
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        <lord-icon src="https://cdn.lordicon.com/xcxzayqr.json" trigger="loop"
                                            delay="500" style="width:28px;height:28px">
                                        </lord-icon>
                                        <!-- <div class="ml-auto">
                                                <x-base.tippy
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        <lord-icon src="https://cdn.lordicon.com/ibanawal.json" trigger="loop"
                                            delay="500" state="in-reveal" style="width:28px;height:28px">
                                        </lord-icon>
                                        <div class="ml-auto">
                                            <!-- <x-base.tippy
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        <lord-icon src="https://cdn.lordicon.com/vhyuhmbl.json" trigger="loop"
                                            delay="500" state="morph-group" style="width:28px;height:28px">
                                        </lord-icon>
                                        <div class="ml-auto">
                                            <!-- <x-base.tippy
                                                    class="flex cursor-pointer items-center rounded-full bg-danger py-[3px] pl-2 pr-1 text-xs font-medium text-white"
                ...
                <div class="col-span-12 mt-8 sm:col-span-6 lg:col-span-3">
                    <div class="intro-y flex h-10 items-center">
                        <h2 class="mr-5 truncate text-lg font-medium">Recaudacion diaria</h2>
                        {{-- <a
                    ...
                    <div class="intro-y">
                        <div class="box zoom-in mb-3 flex items-center px-4 py-4">
                            <div class="image-fit h-10 w-10 flex-none overflow-hidden rounded-md">
                               <lord-icon src="https://cdn.lordicon.com/eaegfqtv.json" trigger="loop" delay="500"
                                    state="in-reveal" style="width:28px;height:28px">
                                </lord-icon>
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box zoom-in mb-3 flex items-center px-4 py-4">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Campo</div>
                                <div class="mt-0.5 text-xs text-slate-500">
                                    05 de julio
                                </div>
                            </div>
                    ...
                    <br><br>
                    <div class="intro-y flex h-10 items-center">
                        <h2 class="mr-5 truncate text-lg font-medium">Recaudacion Mensual</h2>
                        {{-- <a
                            class="ml-auto truncate text-primary"
                            href=""
                        > Show More </a> --}}
                        ...
                        <div class="mt-5">
                            @foreach ($clientes_ubicaciones as $row)
                                <div class="intro-y">
                                    <div class="box zoom-in mb-3 flex items-center px-4 py-4">
                                        <div class="image-fit h-10 w-10 flex-none overflow-hidden rounded-md">
                                            <lord-icon src="https://cdn.lordicon.com/zfmcashd.json" trigger="loop"
                                                delay="500" state="in-reveal" style="width:28px;height:28px">
                                            </lord-icon>
                                        </div>
                                        <div class="ml-4 mr-auto">
